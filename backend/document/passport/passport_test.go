...
const testDocumentType = "passport"
...
func TestPassiveAuthenticationPassport(t *testing.T) {
	...
	for _, tt := range InvalidPassiveAuthInput {
		t.Run(tt.Name, func(t *testing.T) {
			...
			_, err := PassiveAuthenticationPassport(data, tt.PassportCertPool, testDocumentType)
			require.Error(t, err)
...
func TestPassiveAuthenticationPassportWithRealSOD(t *testing.T) {
	...
	_, err := PassiveAuthenticationPassport(data, trustedCerts, testDocumentType)
...
func TestPassiveAuthenticationPassportIgnoresInvalidDG7(t *testing.T) {
	...
	doc, err := PassiveAuthenticationPassport(data, trustedCerts, testDocumentType)
	require.NoError(t, err)
...
func TestActiveAuthenticationPassport(t *testing.T) {
	...
	for _, tt := range InvalidActiveAuthInput {
		t.Run(tt.Name, func(t *testing.T) {
			...
			result, err := ActiveAuthentication(data, doc, testDocumentType)
			require.NoError(t, err)
