        ...
        resources: {
            en: {
                translation: {
                    ...
                    index_store_update_title: "Keep your app up to date",
                    index_store_update_description: "Install the latest version of the Yivi app to get new features and security fixes. Pick your preferred store below.",
            ...
            nl: {
                translation: {
                    ...
                    index_store_update_title: "Houd je app up-to-date",
                    index_store_update_description: "Installeer de nieuwste versie van de Yivi-app voor nieuwe functies en beveiligingsupdates. Kies hieronder je voorkeurswinkel.",
